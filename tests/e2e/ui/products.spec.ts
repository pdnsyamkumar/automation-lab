...
test.describe('Products Page Tests', () => {
  ...
  test(
    `Case 8: Verify All Products and product detail page`,
    { tag: ['@Products'] },
    async ({ homePage, productsPage, page }) => {
      ...
      await test.step(`4: Click on 'Products' button
...
Step 6: The products list is visible`, async () => {
      ...
      await test.step(`8: User is landed to product detail page
...
Step 5: Verify user is navigated to ALL PRODUCTS page successfully`, async () => {
      ...
      await test.step(`6: Enter product name in search input and click search button
Step 7: Verify 'SEARCHED PRODUCTS' is visible`, async () => {
      ...
      await test.step(`9: Verify all the products related to search are visible`, async ({}) => {
  ...
  test(
    ...
    async ({ productsPage, page }) => {
      ...
      await test.step(`5: Click on 'View Product' button`, async () => {
      ...
      await test.step(`7: Enter name, email and review
