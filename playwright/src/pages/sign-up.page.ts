...
export class SignUpPage extends BasePage {
   ...
   * @param param0 Object containing name and email
   */
  async fillNameAndEmailAddress({
    name,
    email,
  }: {
    name: string
   ...
   */
  async fillAccountInformation(accountInfo: AccountInformation) {
    ...
    if (accountInfo.signUpForOurNewsLetter)
