...
import { AccountInformation, AddressInformation, DOB } from "@testData/signup-test-data";
...
export class SignUpPage extends BasePage {
    ...
    readonly getEnterAccountInfoLabel = () => this.page.getByText(`Enter Account Information`);
    readonly getAccountCreatedLabel = () => this.page.getByTestId(`account-created`);
    readonly getAccountDeletedLabel = () => this.page.getByTestId(`account-deleted`);
    readonly getSignUpNameInput = () => this.page.getByTestId(`signup-name`)
    readonly getSignUpEmailAddressInput = () => this.page.getByTestId(`signup-email`)
    readonly getSignUpButton = () => this.page.getByRole(`button`, { name: `Signup` });
    readonly getNamePrefixRadioButton = (title: NamePrefix) => this.page.getByLabel(title);
    ...
    readonly getNewsLetterCheckbox = () => this.page.getByLabel(`Sign up for our newsletter!`);
    readonly getSpecialOffersCheckbox = () => this.page.getByLabel(`Receive special offers from our partners!`);
    ...
    readonly getCreateAccountButton =() => this.page.getByRole(`button`, { name: `Create Account` });
    ...
    async enterAccountInformation(accountInfo: AccountInformation){
        ...
        if(accountInfo.receiveSpecialOffersFromOurPartners) this.getSpecialOffersCheckbox().check();
    }
